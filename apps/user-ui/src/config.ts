...
function resolveConfiguredApiBase(): string {
  const runtimeConfig = ((globalThis as { __NEST_USER_UI_CONFIG__?: RuntimeUserUiConfig }).__NEST_USER_UI_CONFIG__ ??
    (globalThis as { __ORGOPS_USER_UI_CONFIG__?: RuntimeUserUiConfig }).__ORGOPS_USER_UI_CONFIG__);
  return (
